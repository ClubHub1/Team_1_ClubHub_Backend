...
export type NotificationsClientService = Pick<
  NotificationsService<Params<NotificationsQuery>>,
  (typeof notificationsMethods)[number]
>

export const notificationsPath = 'Notifications'

export const notificationsMethods: Array<keyof NotificationsService> = [
  'find',
  'get',
  'create',
  'patch',
